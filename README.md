...
For the remote repository, make a github repository named HW2_Analysis1_Pdalvi, then do;

```bash
git remote add origin git@github.com:PrachiSDalvi/HW2_Analysis1_Pdalvi.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW2_Analysis1_Pdalvi	<- Your notebooks and scripts will live in the main project folder
